...
CREATE TABLE [Employees] (
    ...
    CONSTRAINT [FK_Employees_Employees_EmployeeManager] FOREIGN KEY ([EmployeeManager]) REFERENCES [Employees] ([Id]) ON DELETE NO ACTION
);
GO
...
VALUES (N'20240706152832_InitialMigration', N'8.0.6');
GO
